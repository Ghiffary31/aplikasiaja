...
<div class="breadcrumb">
    <a href="<?php echo APPURL;?>/kendaraan/">Laporan</a> &nbsp;&raquo;&nbsp;
    Edit Data
</div>

<h4 class="content-title">Form Edit Data</h4>
            ...
            <tr>
                ...
                <td>
                    <select name="tahun_pembuatan">
                        ...
                        <option value="kesekretaritan">KASUBAG KESEKRETARIATAN</option>
                        <option value="kepaniteraan">KASUBAG KEPANITERAAN</option>
            ...
            <tr>
                ...
                <td>
                    <select name="jenis">
                        ...
                        <option value="komputer"<?php echo $data['jenis'] == 'mobil' ? ' selected="selected"':'';?>>Komputer</option>
                        <option value="laptop"<?php echo $data['jenis'] == 'truk' ? ' selected="selected"':'';?>>Laptop</option>
                        <option value="printer"<?php echo $data['jenis'] == 'motor' ? ' selected="selected"':'';?>>Printer</option>
                    </select>
                </td>
            </tr>
            <!-- <tr>
